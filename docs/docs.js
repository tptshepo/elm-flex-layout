...
var $tptshepo$elm_flex_layout$Examples$Docs$init = function (_v0) {
...
var $tptshepo$elm_flex_layout$Examples$Docs$update = F2(
	function (msg, model) {
		switch (msg.$) {
...
var $tptshepo$elm_flex_layout$Flex$fxLayout = F3(
	function (direction, alignHorizontal, alignVertical) {
		...
		var computedStyles = _Utils_eq(direction, $tptshepo$elm_flex_layout$Flex$Row) ? _List_fromArray(
			...
			[
				A2($elm$html$Html$Attributes$style, 'place-content', aHorizontal + (' ' + aVertical)),
				A2($elm$html$Html$Attributes$style, 'align-items', aHorizontal)
			]);
...
var $tptshepo$elm_flex_layout$Examples$Docs$blockStyles = F6(
...
var $tptshepo$elm_flex_layout$Examples$Docs$viewBoxContainer = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					_List_Nil,
					A6($tptshepo$elm_flex_layout$Examples$Docs$blockStyles, model.direction, '#009688', '75px', '50px', '75px', '50px')),
				_List_fromArray(
					[
				...
				_Utils_ap(
					_List_Nil,
					A6($tptshepo$elm_flex_layout$Examples$Docs$blockStyles, model.direction, '#3949ab', '75px', '100px', '125px', '50px')),
				_List_fromArray(
					[
				...
				_Utils_ap(
					_List_Nil,
					A6($tptshepo$elm_flex_layout$Examples$Docs$blockStyles, model.direction, '#9c27b0', '75px', '50px', '75px', '50px')),
				_List_fromArray(
					[
				...
				_Utils_ap(
					_List_Nil,
					A6($tptshepo$elm_flex_layout$Examples$Docs$blockStyles, model.direction, '#b08752', '75px', '75px', '100px', '50px')),
				_List_fromArray(
					[
				...
				_Utils_ap(
					_List_Nil,
					A6($tptshepo$elm_flex_layout$Examples$Docs$blockStyles, model.direction, '#5ca6b0', '75px', '50px', '75px', '50px')),
				_List_fromArray(
					[
...
var $tptshepo$elm_flex_layout$Flex$alignmentToString = function (alignment) {
	switch (alignment.$) {
		case 'Start':
			return 'start';
		case 'Center':
...
var $tptshepo$elm_flex_layout$Examples$Docs$viewCodeContainer = function (model) {
	var vAlign = $tptshepo$elm_flex_layout$Flex$alignmentToString(model.verticalAlignment);
	var hAlign = $tptshepo$elm_flex_layout$Flex$alignmentToString(model.horizontalAlignment);
	var direction = _Utils_eq(model.direction, $tptshepo$elm_flex_layout$Flex$row) ? 'Flex.row' : 'Flex.column';
	var code = _Utils_eq(model.direction, $tptshepo$elm_flex_layout$Flex$row) ? ('fxLayout ' + (direction + (' Flex.' + (hAlign + (' Flex.' + vAlign))))) : ('fxLayout ' + (direction + (' Flex.' + (vAlign + (' Flex.' + hAlign)))));
	var body = '\n##### Code Preview\n```elm\nview = \n  div ([] ++ ' + (code + ')\n          [ div [] [ text "1" ]\n          , div [] [ text "2" ]\n          , div [] [ text "3" ]\n          , div [] [ text "4" ]\n          , div [] [ text "5" ]\n          ]\n```\n          ');
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Version: @latest')
						]))
				])),
			A2(
			$elm$html$Html$div,
...
var $tptshepo$elm_flex_layout$Examples$Docs$LayoutDirection = F2(
	function (a, b) {
...
var $tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton = F4(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$checked(innerChecked),
...
var $tptshepo$elm_flex_layout$Examples$Docs$viewToggleDirectionContainer = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Layout Direction')
					])),
				...
				_List_fromArray(
					[
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'direction',
						'Row',
						_Utils_eq(model.direction, $tptshepo$elm_flex_layout$Flex$row),
						$tptshepo$elm_flex_layout$Examples$Docs$LayoutDirection($tptshepo$elm_flex_layout$Flex$row)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'direction',
						'Column',
						_Utils_eq(model.direction, $tptshepo$elm_flex_layout$Flex$column),
						$tptshepo$elm_flex_layout$Examples$Docs$LayoutDirection($tptshepo$elm_flex_layout$Flex$column))
					]))
			]));
};
var $tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment = F2(
	function (a, b) {
...
var $tptshepo$elm_flex_layout$Examples$Docs$viewToggleHorizontalContainer = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$start)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'hAlign',
						'Center',
						_Utils_eq(model.horizontalAlignment, $tptshepo$elm_flex_layout$Flex$center),
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$center)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'hAlign',
						'End',
						_Utils_eq(model.horizontalAlignment, $tptshepo$elm_flex_layout$Flex$end),
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$end)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'hAlign',
						'Space Around',
						_Utils_eq(model.horizontalAlignment, $tptshepo$elm_flex_layout$Flex$spaceAround),
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$spaceAround)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'hAlign',
						'Space Between',
						_Utils_eq(model.horizontalAlignment, $tptshepo$elm_flex_layout$Flex$spaceBetween),
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$spaceBetween)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'hAlign',
						'Space Evenly',
						_Utils_eq(model.horizontalAlignment, $tptshepo$elm_flex_layout$Flex$spaceEvenly),
						$tptshepo$elm_flex_layout$Examples$Docs$HorizontalAlignment($tptshepo$elm_flex_layout$Flex$spaceEvenly))
					]))
			]));
};
var $tptshepo$elm_flex_layout$Examples$Docs$VerticalAlignment = F2(
	function (a, b) {
		return {$: 'VerticalAlignment', a: a, b: b};
	});
var $tptshepo$elm_flex_layout$Examples$Docs$viewToggleVerticalContainer = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$tptshepo$elm_flex_layout$Examples$Docs$VerticalAlignment($tptshepo$elm_flex_layout$Flex$start)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'vAlign',
						'Center',
						_Utils_eq(model.verticalAlignment, $tptshepo$elm_flex_layout$Flex$center),
						$tptshepo$elm_flex_layout$Examples$Docs$VerticalAlignment($tptshepo$elm_flex_layout$Flex$center)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'vAlign',
						'End',
						_Utils_eq(model.verticalAlignment, $tptshepo$elm_flex_layout$Flex$end),
						$tptshepo$elm_flex_layout$Examples$Docs$VerticalAlignment($tptshepo$elm_flex_layout$Flex$end)),
						A4(
						$tptshepo$elm_flex_layout$Examples$Docs$viewRadioButton,
						'vAlign',
						'Stretch',
						_Utils_eq(model.verticalAlignment, $tptshepo$elm_flex_layout$Flex$stretch),
						$tptshepo$elm_flex_layout$Examples$Docs$VerticalAlignment($tptshepo$elm_flex_layout$Flex$stretch))
					]))
			]));
};
var $tptshepo$elm_flex_layout$Examples$Docs$viewTogglesContainer = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$tptshepo$elm_flex_layout$Examples$Docs$viewToggleHorizontalContainer(model),
				$tptshepo$elm_flex_layout$Examples$Docs$viewToggleVerticalContainer(model)
			]));
};
var $tptshepo$elm_flex_layout$Examples$Docs$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$tptshepo$elm_flex_layout$Examples$Docs$viewPageTitleContainer,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Visual Preview')
									])),
								A2(
								$elm$html$Html$div,
								_Utils_ap(
								...
								_List_fromArray(
									[
										...
										$tptshepo$elm_flex_layout$Examples$Docs$viewCodeContainer(model),
										A2($elm$html$Html$br, _List_Nil, _List_Nil),
										A2(
										$elm$html$Html$h5,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text('Layout Toggles')
											])),
										$tptshepo$elm_flex_layout$Examples$Docs$viewTogglesContainer(model)
									]))
							]))
					]))
			]));
};
var $tptshepo$elm_flex_layout$Examples$Docs$main = $elm$browser$Browser$element(
	{
		init: $tptshepo$elm_flex_layout$Examples$Docs$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $tptshepo$elm_flex_layout$Examples$Docs$update,
		view: $tptshepo$elm_flex_layout$Examples$Docs$view
	});
_Platform_export({'Examples':{'Docs':{'init':$tptshepo$elm_flex_layout$Examples$Docs$main(
